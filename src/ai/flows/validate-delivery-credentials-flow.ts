...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an API validator for BRICO PRO DZ.
...
- tariffs: Generate a full array of delivery tariffs for ALL 48 Algerian wilayas (states 01 to 48).
...
You MUST return a complete list of 48 tariffs.`,
});
